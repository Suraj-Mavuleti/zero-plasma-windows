...
class App(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Zero Plasma Console")
        ...
        # Branding
        self.logo_label = ctk.CTkLabel(self.sidebar, text="PLASMA", font=ctk.CTkFont("Segoe UI", size=26, weight="bold"), text_color=self.accent_color)
        ...
        self.header = ctk.CTkLabel(self.main_view, text="Zero Plasma Console", font=ctk.CTkFont("Segoe UI", size=32, weight="bold"), text_color=self.text_primary)
